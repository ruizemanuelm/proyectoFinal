  ...
  const Registro = (administrador) => {
    registro(administrador).then((respuesta) => {
      if (respuesta?.status === 201) {
        Swal.fire("Se creo un usuario nuevo");
        reset();
      } else {
        Swal.fire("Ocurrió un error", "el email o contraseña es invalido");
      }
    });
  };
  return (
      ...
      <Container>
        ...
        <div className="text-center">
          <h2 className="fs-4 mt-5">
            Los privilegios como administrador incluyen:
          </h2>
        </div>
            ...
            <Card className="h-100 rounded-end-0">
              <Card.Body className="justify-content-center">
                ...
                <Card.Text className="text-center">
                  Programar, modificar y cancelar citas, asignando fechas y
                  horas, y mantener actualizados los registros de citas
                  programadas.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col className="mb-4" md={6} sm={12} lg={3}>
            <Card className="h-100 rounded-0">
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  Acceder y actualizar información de pacientes, incluyendo
                  datos médicos, historiales de tratamientos y vacunas.{" "}
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col className="mb-4" md={6} sm={12} lg={3}>
            <Card className="h-100 rounded-0">
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  Responsable de confirmar citas, recordar visitas futuras y
                  responder a preguntas de clientes sobre horarios y
                  procedimientos.{" "}
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col className="mb-4" md={6} sm={12} lg={3}>
            <Card className="h-100 rounded-start-0">
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  Autoridad para gestionar citas de emergencia y priorizar
                  atención médica en situaciones críticas.{" "}
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
