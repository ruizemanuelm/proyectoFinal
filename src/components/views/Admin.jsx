...
const Admin = () => {
    ...
    >
      ...
      <Card.Body>
        <Card.Title className='fs-3 text-center'>Turnos del dia</Card.Title>
...
<Card.Img className='rounded-5' variant="top" src="https://img.freepik.com/vector-gratis/avatar-personaje-empresario-aislado_24877-60111.jpg" />
</Col>
<Col sm={12} md={6}>
<ListGroup variant="flush" className='align-content-center'>
  <p className='fs-4 mt-3'>Nombre de usuario</p>
        <ListGroup.Item action variant="primary" className='fs-3 rounded-4'>User123</ListGroup.Item>
  <p className='fs-4 mt-3'>Correo</p>
        <ListGroup.Item action variant="danger" className='fs-3 rounded-4'>User123@mail.com</ListGroup.Item>
  <p className='fs-4 mt-3'>Contraseña</p>
        <ListGroup.Item action variant="warning" className='fs-3 rounded-4'>12345678</ListGroup.Item>
      </ListGroup>
</Col>
        </Row>
      </Card.Body>
